...
inline void step_agents_avx2(
    ...
    __m256 c10_neg = _mm256_set1_ps(-1.733f);
    __m256 c_limit = _mm256_set1_ps(1.733f);
    u = _mm256_max_ps(c10_neg, _mm256_min_ps(u, c_limit));
    v = _mm256_max_ps(c10_neg, _mm256_min_ps(v, c_limit));
